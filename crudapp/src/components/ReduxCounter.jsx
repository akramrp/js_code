...
const ReduxCounter = () => {
    ...
    return (
        <Box sx={{ textAlign: 'center', marginTop: 5 }}>
            ...
            <Divider orientation='vertical'>Counter Section</Divider>
            <Counter />

            <br /><br />
            <Divider orientation='vertical'>Coin Section</Divider>
            <Coin />

            <br /><br />
            <Divider orientation='vertical'>Theme Section</Divider>
            <Theme />
